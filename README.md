...
| `/display` | **1530 × 896 px** | จอกลาง แสดงชื่อและเปอร์เซ็นต์ของแต่ละตัวเลือก โดยไม่แสดงจำนวนโหวต |
...
- Screen Mapping ของจอซ้ายและจอขวาเลือกช้อยได้หลายรายการแบบ checkbox โดยแต่ละจอเลือกชุดช้อยต่างกันได้
...
- แก้ข้อความเชิญร่วมโหวตใต้คำถามแยกสำหรับโพลแต่ละชุด และรักษาการขึ้นบรรทัดกับช่องว่างตามที่พิมพ์
- จอกลางช่วงแสดงผลโพลแสดงเฉพาะชื่อ เปอร์เซ็นต์ และแถบผล ส่วนจำนวนโหวตยังกรอกและคำนวณใน Admin ตามเดิม
- เลือกโหมดจอรวม จอคู่ หรือเต็มจอ และดูตัวอย่างสดครบทั้ง 3 URL
- Screen Mapping เลือกเนื้อหาของจอซ้าย/กลาง/ขวาแยกกัน: คำถาม, ทุกตัวเลือก, ช้อยที่เลือกหนึ่งหรือหลายรายการ หรือยอดโหวตรวม จอแนวตั้งจะจัดสัดส่วนอัตโนมัติตามจำนวนช้อย
- ตั้งภาพพื้นหลังและรูปประกอบแยกตามแต่ละตัวเลือกด้วย URL หรืออัปโหลดเข้า Supabase Storage พร้อมปรับขนาดและตำแหน่ง ภาพจะตามตัวเลือกไปยังจอที่กำหนดใน Screen Mapping
...
- ปรับความเร็ว animation ของตัวเลขและแถบคะแนนได้ตั้งแต่ `0.25×` ถึง `3×`
...
3. เลือกแท็บ **โพลชุดที่ 1** หรือ **โพลชุดที่ 2** แล้วกรอกคำถาม ตัวเลือก คะแนน และปรับภาพ ใช้ปุ่ม **เพิ่มตัวเลือก** ได้สูงสุด 6 ตัวเลือก โดยแต่ละตัวเลือกจะมีแผงปรับภาพพื้นหลัง รูปประกอบ ขนาด และตำแหน่งของตัวเอง
4. ที่ **กำหนดเนื้อหาแต่ละจอ** เลือก “เลือกช้อยที่จะแสดง” แล้วติ๊กช้อยสำหรับจอซ้ายและจอขวาได้หลายรายการ ทั้งสองจอไม่จำเป็นต้องเลือกเหมือนกัน
5. ถ้าเป็นชุดที่ยังไม่ออกจอ กด **บันทึกแบบร่าง** ได้โดยจอสดไม่เปลี่ยน
6. เมื่อพร้อม กด **นำโพลชุดนี้ขึ้นจอ** ระบบจะเริ่มด้วยหน้า “แสดงคำถาม”
7. ใช้ตัวเลือก **สถานะบนจอ** เพื่อเปลี่ยนเป็น “แสดงผลโพล” หรือ “แสดงยอดรวม” ทุกจอจะเปลี่ยนพร้อมกันโดยใช้ URL เดิม
8. หากกรอกผิด ไปที่ประวัติของโพลชุดนั้นแล้วกด **คืนค่าเดิม**
